...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/nelmar18/portfolio.git
   cd portfolio
   ```
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/nelmar18/portfolio/issues).
