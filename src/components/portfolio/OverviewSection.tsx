                ...
                <div className="space-y-4 md:space-y-6">
                  ...
                  <div className="space-y-3 md:space-y-4 border-t border-gray-200/50 dark:border-gray-700/50 pt-4 md:pt-6">
                    <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                      I help startups and businesses design, build, and launch intelligent, production-ready software—from MVPs to large-scale systems.
                    </p>
                    <p className="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
                      I combine strong engineering fundamentals with hands-on AI/ML implementation to deliver solutions that are innovative, reliable, secure, and easy to maintain.
                    </p>
                  </div>
                  ...
                  <div className="border-t border-gray-200/50 dark:border-gray-700/50 pt-4 md:pt-6">
                    ...
                    <div className="flex flex-wrap gap-2 md:gap-3">
                      {["Python", "Node.js", "Django", "FastAPI", "Express", "React", "Next.js", "TypeScript", "React Native", "Flutter", "OpenAI", "TensorFlow", "PyTorch", "PostgreSQL", "MongoDB", "Firebase", "AWS", "Docker"].map((skill, index) => (
                        <motion.span
                          key={skill}
          ...
          <motion.div variants={itemVariants} className="lg:col-span-4 space-y-6 mt-6 lg:mt-0">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50/90 to-pink-50/90 dark:from-purple-950/30 dark:to-pink-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              ...
              <div className="space-y-3">
                <motion.a
                  href="mailto:camisoranelmar18@gmail.com"
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white break-all">camisoranelmar18@gmail.com</div>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">nelmar-portfolio.vercel.app</div>
                  </div>
                </motion.div>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-emerald-50/90 to-cyan-50/90 dark:from-emerald-950/30 dark:to-cyan-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              ...
              <div className="space-y-3.5">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-800 dark:text-gray-300">Remote Available</span>
                </motion.div>
              </div>
            </div>
          </motion.div>
