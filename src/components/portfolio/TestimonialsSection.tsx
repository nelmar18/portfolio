...
const testimonials = [
  {
    content: "Nelmar is great! He is very skillful and fast learner, just what you need in a developer.",
  ...
  {
    content: "Nelmar produced some really amazing work on the backend. He demonstrated his proficiency and efficiency by using Node.js and Javascript to successfully import a very large dataset into a MySQL database.",
    author: "Arnel Bisnar",
  ...
  {
    content: "It's been great to work with him! Fast, active and hardworking! Nelmar architected checkersvip.com from ground up with great attention to detail and great design. He is a great team player and a great developer.",
